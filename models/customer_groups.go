...
//
// swagger:model CustomerGroups
type CustomerGroups struct {
	List

	// items
	Items []*CustomerGroup `json:"items"`
}

// UnmarshalJSON unmarshals this object from a JSON structure
func (m *CustomerGroups) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 List
...
func (m *CustomerGroups) validateItems(formats strfmt.Registry) error {
